...
//弹出层
var cnt_who = "<img width='708px' height='419px' src='image/start_who.jpg' />";
T$('click_who').onclick = function(){TINY.box.show(cnt_who,0,0,0,1)}
var cnt_what = "<img width='708px' height='419px' src='image/start_what.jpg' />";
T$('click_what').onclick = function(){TINY.box.show(cnt_what,0,0,0,1)}
var cnt_how= "<img width='708px' height='419px' src='image/start_how.jpg' />";
